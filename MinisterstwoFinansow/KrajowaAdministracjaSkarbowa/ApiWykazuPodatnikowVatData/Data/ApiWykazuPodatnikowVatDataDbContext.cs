...
namespace ApiWykazuPodatnikowVatData.Data
{
    ...
    /// </summary>
    public class ApiWykazuPodatnikowVatDataDbContext : DbContext
    {
        ...
        /// </summary>
        /// <param name="options">
        ///     Opcje połączenia da bazy danych options AS DbContextOptions
            ...
            try
            {
                if (!optionsBuilder.IsConfigured)
                {
                    optionsBuilder.UseSqlServer(_appSettings.GetConnectionString(),
                        x => x.MigrationsHistoryTable("__EFMigrationsHistory", "awpv"));
                }
            }
            catch (Exception e)
            {
        ...
        ///     ModelBuilder modelBuilder
        /// </param>
        private void OnModelCreatingPartial(ModelBuilder modelBuilder) => throw new NotImplementedException();
        ...
        ///     Memory Cache Entry Options
        /// </returns>
        public MemoryCacheEntryOptions GetMemoryCacheEntryOptions() => _memoryCacheEntryOptions;
