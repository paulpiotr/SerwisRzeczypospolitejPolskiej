...
namespace ApiWykazuPodatnikowVatData.Models
{
    ...
    public class Entity
    {
        ...
        [Display(Name = "Identyfikator podmiotu gospodarczego", Prompt = "Wpisz identyfikator podmiotu gospodarczego",
            Description = "Identyfikator podmiotu gospodarczego, klucz główny")]
        ...
        [Display(Name = "Firma (nazwa) lub imię i nazwisko", Prompt = "Wpisz firmę (nazwę) lub imię i nazwisko",
        ...
        [Display(Name = "Status podatnika VAT", Prompt = "Wybierz status podatnika VAT",
            Description = "Status podatnika VAT, (Czynny lub Zwolniony lub Niezarejestrowany)")]
        [StringLength(32)]
        [MinLength(1)]
        [MaxLength(32)]
        ...
        [Display(Name = "Adres stałego miejsca prowadzenia działalności lub adres miejsca zamieszkania",
            Prompt =
                "Wpisz adres stałego miejsca prowadzenia działalności lub adres miejsca zamieszkania w przypadku braku adresu stałego miejsca prowadzenia działalności",
            Description =
        ...
        [Display(
            ...
            Prompt = "Dodaj osoby wchodzące w skład organu uprawnionego do reprezentowania podmiotu",
            Description =
                "Imiona i nazwiska osób wchodzących w skład organu uprawnionego do reprezentowania podmiotu oraz ich numery NIP i / lub PESEL")]
        ...
        [Display(Name = "Imiona i nazwiska prokurentów oraz ich numery NIP i/lub PESEL",
            Prompt = "Dodaj osoby prokurentów oraz ich numery NIP i/lub PESEL",
            Description = "Imiona i nazwiska prokurentów oraz ich numery NIP i/lub PESEL")]
        ...
        /// </summary
        [NotMapped]
        [Display(Name = "Imiona i nazwiska lub firmę (nazwa) wspólnika oraz jego numery NIP i/lub PESEL",
            Prompt =
                "Dodaj osoby wspólników Imiona i nazwiska lub firmę (nazwa) wspólnika oraz jego numery NIP i/lub PESEL",
            Description = "Imiona i nazwiska lub firmę (nazwa) wspólnika oraz jego numery NIP i/lub PESEL")]
        ...
        [Display(Name = "Data rejestracji jako podatnika VAT",
            Prompt = "Wpisz lub wybierz datę rejestracji jako podatnika VAT",
            Description = "Data rejestracji jako podatnika VAT")]
        ...
        [Display(Name = "Data odmowy rejestracji jako podatnika VAT",
            Prompt = "Wpisz lub wybierz datę odmowy rejestracji jako podatnika VAT",
            Description = "Data odmowy rejestracji jako podatnika VAT")]
        ...
        [Display(Name = "Podstawa prawna odmowy rejestracji", Prompt = "Wpisz podstawę prawną odmowy rejestracji",
            Description = "Podstawa prawna odmowy rejestracji")]
        [StringLength(200)]
        [MaxLength(200)]
        ...
        [Display(Name = "Data przywrócenia jako podatnika VAT",
            Prompt = "Wpisz lub wybierz datę przywrócenia jako podatnika VAT",
            Description = "Data przywrócenia jako podatnika VAT")]
        ...
        [Display(Name = "Podstawa prawna przywrócenia jako podatnika VAT",
            Prompt = "Wpisz podstawę prawną przywrócenia jako podatnika VAT",
            Description = "Podstawa prawna przywrócenia jako podatnika VAT")]
        [StringLength(200)]
        [MaxLength(200)]
        ...
        [Display(Name = "Data wykreślenia odmowy rejestracji jako podatnika VAT",
            Prompt = "Wpisz lub wybierz datę wykreślenia odmowy rejestracji jako podatnika VAT",
            Description = "Data wykreślenia odmowy rejestracji jako podatnika VAT")]
        ...
        [Display(Name = "Podstawa prawna wykreślenia odmowy rejestracji jako podatnika VAT",
            Prompt = "Wpisz podstawę prawną wykreślenia odmowy rejestracji jako podatnika VAT",
            Description = "Podstawa prawna wykreślenia odmowy rejestracji jako podatnika VAT")]
        [StringLength(200)]
        [MaxLength(200)]
        ...
        [Display(Name = "Numery kont bankowych w formacie NRB", Prompt = "Dodaj numery kont bankowych w formacie NRB",
            Description = "Numery kont bankowych w formacie NRB")]
        ...
        [Display(Name = "Podmiot posiada maski kont wirtualnych",
            Prompt = "Wybierz, czy podmiot posiada maski kont wirtualnych",
            Description = "Podmiot posiada maski kont wirtualnych")]
        ...
        [Display(Name = "Data sprawdzenia (wysłania żądania)",
            Prompt = "Wpisz lub wybierz datę sprawdzenia (wysłania żądania)",
            Description = "Data sprawdzenia (wysłania żądania)")]
        ...
        /// </returns>
        public string GetValuesToString(string separator = null) => ObjectHelper.GetValuesToString(this, separator);
