...
namespace ApiWykazuPodatnikowVatData.Models
{
    ...
    public class RequestAndResponseHistory
    {
        ...
        [Display(Name = "Identyfikator historii wyszukiwania", Prompt = "Wpisz identyfikator historii wyszukiwania",
            Description = "Identyfikator historii wyszukiwania, klucz główny")]
        ...
        ///     T restResponse
        /// </param>
        public RequestAndResponseHistory SetRequestAndResponseHistory<T>(RestClient client, RestRequest request,
        ...
        public RequestAndResponseHistory SetObjectMD5Hash(string separator = null)
        {
            try
            {
                ObjectMD5Hash = ObjectHelper.ConvertObjectValuesToMD5Hash(this, separator);
            }
            catch (Exception)
            {
                ObjectMD5Hash = null;
